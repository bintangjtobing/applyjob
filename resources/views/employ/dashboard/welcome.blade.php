...
<head>
    ...
    <title>Company Dashboard | @yield('titledashboard')</title>
    <!-- Favicon icon -->
                        ...
                        <li class="icons dropdown">
                            ...
                            <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        {{-- <li>
                                            <a href="app-profile#"><i class="icon-user"></i>
                                                <span>Profile</span></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void()">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-speedometer menu-icon"></i><span class="nav-text">Your Account</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="/dashboad/company/">Account Info</a></li>
                        </ul>
                    </li>
                    <li class="nav-label">Candidate</li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-speedometer menu-icon"></i><span class="nav-text">Your Account</span>
                        </a>
