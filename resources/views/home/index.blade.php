@extends('welcome')
@section('titlepage','Jobpply.com | Situs Lowongan Kerja Bagi Pejuang IT')
@section('descpage','')
@section('content')
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="browse-job p-5">
                    ...
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Corrupti recusandae deleniti ipsa quos
                        necessitatibus quam pariatur exercitationem, fugit facere, suscipit a in facilis placeat sunt
                        unde temporibus beatae aperiam maxime.</p>
                </div>
            </div>
        </div>
    </div>
